log_dir=/workspace/data/fast_logs/opt3
mkdir -p ${log_dir}
...
model_name_arr=("opt-13b" "opt-13b" "opt-30b" "opt-30b" "opt-66b" "opt-66b")
input_len_arr=(960 960 960 960 960 960)
out_len_arr=(20 80 20 80 20 80)
# num_gpu_arr=(1 2 4 8)
bs_arr=(1 1 1 1 1 1)
num_bs=1
