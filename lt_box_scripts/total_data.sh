...
log_dir=/workspace/data/fast_logs/opt2_2
mkdir -p ${log_dir}
gpu_logs=${log_dir}/gpu_logs
cpu_logs=${log_dir}/cpu_logs
mkdir -p ${gpu_logs}
...
model_name_arr=("opt-30b" "opt-30b" "opt-30b" "opt-30b" "opt-66b" "opt-66b" "opt-66b" "opt-66b")
# input_len_arr=(512 512 512 512)
input_len=512
# out_len_arr=(64 64 64 64)
out_len=64
bs_arr=(1 8 16 24 1 8 16 24)
num_bs=1
percent_arr=('dir_0' 'dir_1' 'dir_2')
device_arr=('0,1,2,3,5,6,7,8' '0,1,2,3,4,5,6,7' '0,1,2,4,5,6,7,9')
