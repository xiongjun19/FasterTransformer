...
def load_opt_model(in_file):
    model_cfg, model_args, model_kwargs = get_config(OPTForCausalLM, in_file)
    org_model = OPTForCausalLM(model_cfg, *model_args, **model_kwargs)
...
def split_and_convert(args):
    ...
    model = load_opt_model(args.in_file)
