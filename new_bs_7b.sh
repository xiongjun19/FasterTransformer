log_dir=/workspace/data/fast_logs/opt6.7b
mkdir -p ${log_dir}
...
# model_name_arr=("opt-6.7b" "opt-6.7b" "opt-6.7b" "opt-6.7b" "opt-6.7b" )
model_name_arr=("opt-6.7b" "opt-6.7b" "opt-6.7b")
input_len_arr=(512 512 512)
out_len_arr=(64 64)
# num_gpu_arr=(1 2 4 8)
# bs_arr=(48 96 1 8 16 32 64)
bs_arr=(128 256 512)
num_bs=1
...
for(( i=0;i<${#model_name_arr[@]};i++)) do
   bs=${bs_arr[i]};
   input_len=${input_len_arr[0]};
   out_len=${out_len_arr[0]};
